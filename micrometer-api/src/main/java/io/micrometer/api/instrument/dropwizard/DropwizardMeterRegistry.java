...
public abstract class DropwizardMeterRegistry extends MeterRegistry {
    ...
    @Override
    protected <T> io.micrometer.api.instrument.Gauge newGauge(Meter.Id id, @Nullable T obj, ToDoubleFunction<T> valueFunction) {
    ...
    /**
     * @return Value to report when {@link io.micrometer.api.instrument.Gauge#value()} returns {@code null}.
     */
