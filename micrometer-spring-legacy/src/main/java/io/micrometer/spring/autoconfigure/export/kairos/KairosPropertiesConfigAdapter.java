 ...
 * @since 1.1.0
 */
public class KairosPropertiesConfigAdapter extends StepRegistryPropertiesConfigAdapter<KairosProperties> implements KairosConfig {

    public KairosPropertiesConfigAdapter(KairosProperties properties) {
        super(properties);
    }
