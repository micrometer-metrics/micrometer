...
import io.micrometer.binder.kafka.KafkaConsumerMetrics;
...
/**
 * Tests for {@link io.micrometer.binder.kafka.KafkaConsumerMetrics}.
 *
...
class KafkaConsumerMetricsTest {
    ...
    private io.micrometer.binder.kafka.KafkaConsumerMetrics kafkaConsumerMetrics = new KafkaConsumerMetrics(tags);
