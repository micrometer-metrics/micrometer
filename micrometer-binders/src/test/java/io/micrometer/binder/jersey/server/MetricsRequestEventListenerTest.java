...
/**
 * Tests for {@link io.micrometer.binder.jersey.server.MetricsApplicationEventListener}.
 *
...
class MetricsRequestEventListenerTest extends JerseyTest {
    ...
    protected Application configure() {
        ...
        final io.micrometer.binder.jersey.server.MetricsApplicationEventListener listener = new MetricsApplicationEventListener(
