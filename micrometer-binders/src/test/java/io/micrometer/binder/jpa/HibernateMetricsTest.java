...
import io.micrometer.binder.jpa.HibernateMetrics;
...
/**
 * Tests for {@link io.micrometer.binder.jpa.HibernateMetrics}.
 *
...
class HibernateMetricsTest {
    ...
    void deprecatedMonitorShouldExposeMetricsWhenStatsEnabled() {
        io.micrometer.binder.jpa.HibernateMetrics.monitor(registry, entityManagerFactory, "entityManagerFactory");
        assertThatMonitorShouldExposeMetricsWhenStatsEnabled();
    }

    @Test
    void monitorShouldExposeMetricsWhenStatsEnabled() {
        io.micrometer.binder.jpa.HibernateMetrics.monitor(registry, sessionFactory, "sessionFactory");
        assertThatMonitorShouldExposeMetricsWhenStatsEnabled();
    }
