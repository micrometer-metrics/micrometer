 ...
 */
package io.micrometer.binder.jpa;
...
import io.micrometer.binder.jpa.HibernateQueryMetrics;
...
/**
 * Tests for {@link io.micrometer.binder.jpa.HibernateQueryMetrics}.
 *
...
class HibernateQueryMetricsTest {
    ...
    private io.micrometer.binder.jpa.HibernateQueryMetrics hibernateQueryMetrics = new io.micrometer.binder.jpa.HibernateQueryMetrics(mock(SessionFactory.class), "HibernateQueryMetricsTest", Tags.empty());
