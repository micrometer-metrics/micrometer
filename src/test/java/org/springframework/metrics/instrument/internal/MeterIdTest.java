...
class MeterIdTest {
    ...
    void idEqualityAndHashCode() {
        MeterId id1 = new MeterId("foo", tags("k1", "v1", "k2", "v2"));
        MeterId id2 = new MeterId("foo", tags("k1", "v1", "k2", "v2"));
        MeterId id3 = new MeterId("foo", tags("k2", "v2", "k1", "v1"));
        MeterId id4 = new MeterId("foo", tags("k1", "v1"));
        MeterId id5 = new MeterId("bar", tags("k1", "v1", "k2", "v2"));
