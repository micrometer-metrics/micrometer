...
public class ExecutorServiceMetrics implements MeterBinder {
    ...
    public static ExecutorService monitor(MeterRegistry registry, ExecutorService executor, String executorServiceName,
        ...
        ExecutorServiceMetrics executorServiceMetrics = new ExecutorServiceMetrics(executor, executorServiceName, metricPrefix, tags);
        executorServiceMetrics.bindTo(registry);
        return new TimedExecutorService(registry, executor, executorServiceName, sanitizePrefix(metricPrefix), tags, executorServiceMetrics.registeredMeterIds);
    }
