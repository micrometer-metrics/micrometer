...
public class JvmMemoryMetrics implements MeterBinder {
    ...
    public JvmMemoryMetrics(Iterable<? extends Tag> tags) {
        this.tags = tags;
    }
    ...
    public void bindTo(MeterRegistry registry) {
        for (BufferPoolMXBean bufferPoolBean : ManagementFactory.getPlatformMXBeans(BufferPoolMXBean.class)) {
            Iterable<? extends Tag> tagsWithId = Tags.concat(tags, "id", bufferPoolBean.getName());
        ...
        for (MemoryPoolMXBean memoryPoolBean : ManagementFactory.getPlatformMXBeans(MemoryPoolMXBean.class)) {
            ...
            Iterable<? extends Tag> tagsWithId = Tags.concat(tags, "id", memoryPoolBean.getName(), "area", area);
