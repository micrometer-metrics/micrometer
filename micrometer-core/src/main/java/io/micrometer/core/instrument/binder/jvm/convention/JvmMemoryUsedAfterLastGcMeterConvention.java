...
/**
 * Convention for JVM memory used after last GC metrics.
 *
 * @see io.micrometer.core.instrument.binder.jvm.JvmMemoryMetrics
 * @since 1.18.0
 */
public interface JvmMemoryUsedAfterLastGcMeterConvention {
    ...
    /**
     * Create a {@link JvmMemoryUsedAfterLastGcMeterConvention} with the given name.
     * @param name meter name
     * @return a new convention instance
     */
    static JvmMemoryUsedAfterLastGcMeterConvention of(String name) {
        return () -> name;
    }

    /**
     * Create a {@link JvmMemoryUsedAfterLastGcMeterConvention} with the given name and
     * tags function.
     * @param name meter name
     * @param tagsFunction function to derive tags from a {@link MemoryPoolMXBean}
     * @return a new convention instance
     */
    static JvmMemoryUsedAfterLastGcMeterConvention of(String name, Function<MemoryPoolMXBean, Tags> tagsFunction) {
        return new JvmMemoryUsedAfterLastGcMeterConvention() {
            @Override
