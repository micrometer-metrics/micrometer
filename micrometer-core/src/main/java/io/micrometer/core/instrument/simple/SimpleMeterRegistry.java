...
public class SimpleMeterRegistry extends AbstractMeterRegistry {
    ...
    public Counter counter(String name, Iterable<Tag> tags) {
        return MapAccess.computeIfAbsent(meterMap, new MeterId(name, Tags.concat(tags, commonTags)), SimpleCounter::new);
    }

    @Override
    public <T> T counter(String name, Iterable<Tag> tags, T obj, ToDoubleFunction<T> f) {
        MapAccess.computeIfAbsent(meterMap, new MeterId(name, Tags.concat(tags, commonTags)), id -> new FunctionTrackingCounter<>(id, obj, f));
        return obj;
    }
    ...
    public LongTaskTimer longTaskTimer(String name, Iterable<Tag> tags) {
        return MapAccess.computeIfAbsent(meterMap, new MeterId(name, Tags.concat(tags, commonTags)), id -> new SimpleLongTaskTimer(id, getClock()));
    }
