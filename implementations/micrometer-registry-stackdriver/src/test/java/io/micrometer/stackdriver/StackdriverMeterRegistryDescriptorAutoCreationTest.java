...
public class StackdriverMeterRegistryDescriptorAutoCreationTest {

    @Test
    public void disabledAutoCreationShouldNotCreateMetricDescriptor() {
    ...
    @Test
    public void enabledAutoCreationShouldCreateMetricDescriptor() {
        var mockClient = mock(MetricServiceClient.class);
