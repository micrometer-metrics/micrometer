...
/**
 * This is an internal class only intended for use within Micrometer.
...
public class LogbackMetricsSuppressingManySink implements Sinks.Many<String> {
    ...
    public Sinks.EmitResult tryEmitNext(String s) {
        throw new UnsupportedOperationException("use emitNext instead");
    }

    @Override
    public Sinks.EmitResult tryEmitComplete() {
        throw new UnsupportedOperationException("use emitComplete instead");
    }

    @Override
    public Sinks.EmitResult tryEmitError(Throwable error) {
        throw new UnsupportedOperationException("use emitError instead");
    }
