...
/**
 * Tests for {@link BigQueryNamingConvention}.
 *
 * @author Lui Baeumer
 */
class BigQueryNamingConventionTest {
    ...
    @Test
    void tableCannotBeATagKey() {
        assertThat(catchThrowable(() -> convention.tagKey("_TABLE_"))).isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void respectDelegateNamingConvention() {
        ...
        BigQueryNamingConvention convention = new BigQueryNamingConvention(delegateNamingConvention);
