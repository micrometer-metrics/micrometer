...
* <<micrometer-observation-annotations, Using Annotations With @Observed and @ObservedKeyValueTag>>
...
== Using Annotations With @Observed and @ObservedKeyValueTag
...
Also, you can use `@ObservedKeyValueTag` annotation to add tags via method parameters.
