...
* <<micrometer-observation-annotations, Using Annotations With @Observed and @ObservedKeyValue>>
...
== Using Annotations With @Observed and @ObservedKeyValue
...
Also, you can use `@ObservedKeyValue` annotation to add tags via method parameters.
