...
This is what the Observation state diagram looks like:
...
This is what the Observation Scope state diagram looks like:
...
In this section we will describe a high-level overview of Micrometer Observation components. You can read more about those in xref:./components.adoc[this part of the documentation].
