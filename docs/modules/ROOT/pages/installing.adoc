...
NOTE: If you use a framework, it might already come with a BOM that defines the Micrometer versions or imports the Micrometer BOM. If this is the case (for example if you use Spring Boot), you can skip configuring the Micrometer BOM.
