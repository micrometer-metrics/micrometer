...
-----
// Setting up instrumentation
include::{include-core-test-java}/io/micrometer/core/instrument/binder/db/AbstractPostgreSQLDatabaseMetricsIntegrationTest.java[tags=setup, indent=0]

// Usage example
include::{include-core-test-java}/io/micrometer/core/instrument/binder/db/AbstractPostgreSQLDatabaseMetricsIntegrationTest.java[tags=result, indent=0]
-----
