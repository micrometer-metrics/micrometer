...
https://commons.apache.org/proper/commons-pool/[Apache Commons Pool] is an open source software library that provides an object-pooling API and a number of object pool implementations.
