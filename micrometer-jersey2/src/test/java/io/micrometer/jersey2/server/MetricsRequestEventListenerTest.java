...
public class MetricsRequestEventListenerTest extends JerseyTest {
    ...
    public void resourcesAreTimed() {
        ...
        assertThat(registry.find(METRIC_NAME)
            .tags(tagsFrom("/", 200, null)).timer())
            .hasValueSatisfying(t -> assertThat(t.count()).isEqualTo(1));

        assertThat(registry.find(METRIC_NAME)
            .tags(tagsFrom("/hello", 200, null)).timer())
            .hasValueSatisfying(t -> assertThat(t.count()).isEqualTo(2));

        assertThat(registry.find(METRIC_NAME)
            .tags(tagsFrom("/hello/{name}", 200, null)).timer())
            .hasValueSatisfying(t -> assertThat(t.count()).isEqualTo(1));

        assertThat(registry.find(METRIC_NAME)
            .tags(tagsFrom("/sub-resource/sub-hello/{name}", 200, null)).timer())
            .hasValueSatisfying(t -> assertThat(t.count()).isEqualTo(1));
    ...
    public void notFoundIsAccumulatedUnderSameUri() {
        ...
        assertThat(registry.find(METRIC_NAME)
            .tags(tagsFrom("NOT_FOUND", 404, null)).timer())
            .hasValueSatisfying(t -> assertThat(t.count()).isEqualTo(2));
    }
    ...
    public void redirectsAreAccumulatedUnderSameUri() {
        ...
        assertThat(registry.find(METRIC_NAME)
            .tags(tagsFrom("REDIRECTION", 302, null)).timer())
            .hasValueSatisfying(t -> assertThat(t.count()).isEqualTo(1));

        assertThat(registry.find(METRIC_NAME)
            .tags(tagsFrom("REDIRECTION", 307, null)).timer())
            .hasValueSatisfying(t -> assertThat(t.count()).isEqualTo(1));
    }
    ...
    public void exceptionsAreMappedCorrectly() {
        ...
        assertThat(registry.find(METRIC_NAME).tags(
